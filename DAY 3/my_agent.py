...
SYSTEM_PROMPT = (
    ...
    "If the fee is above 25000, use send_email to send a warning email to the student. "
)
...
if __name__ == "__main__":
    ...
    question = ("Read notice.html and tell me what is 15% of the AI202 fee.")
    print("Q:", question)
    print("A:", agent(question))
    question = ("Read notice.html and tell me the total fee for hostel student,all three courses "
                "including laboratory charges")
    print("Q:", question)
    print("A:", agent(question))
    question = ("Write one line welcome message for new students")
    print("Q:", question)
    print("A:", agent(question))
    question = ("Read notice.html and summarise it.")
    print("Q:", question)
    print("A:", agent(question))
