...
def calculator(expression: str) -> str:
    """Evaluate arithmetic expressions such as (12000 + 18000) * 0.9."""
    try:
        return str(
            _evaluate(
...
TOOLS = [
    {
        ...
        "function": {
            "name": "get_course_fee",
            "description": "Get the fee in rupees for a single course code.",
            "parameters": {
                "type": "object",
                "properties": {
                    "course_code": {
    ...
    },
    {
        ...
        "function": {
            "name": "calculator",
            "description": "Evaluate arithmetic expressions using + - * / and brackets.",
            "parameters": {
                "type": "object",
                "properties": {
                    "expression": {
